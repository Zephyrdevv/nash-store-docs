...
Config.Subscriptions = {
    ...
    Tiers = {
        ...
        -- New Black tier
        {
            ...
            description = 'Black card — raised limits without crypto',
            highlights = {
                { icon = 'transfer', text = 'Unlimited transfers' },
                { icon = 'atm',      text = 'Unlimited withdrawals' },
                { icon = 'star',     text = '3 NashPoints for every 10€ spent' },
                { icon = 'invest',   text = 'Full access to investment markets' },
                { icon = 'support',  text = 'Extended customer support' },
            },
            features = {
                maxCards = 3,
                maxTransferPerDay = -1,
